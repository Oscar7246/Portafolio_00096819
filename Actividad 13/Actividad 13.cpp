...
bool buscarLibroEspanol() {
    ...
    while(s != NULL && (s->dato).espanol != LibroEspa)
        s = s->sig;
...
void menu(){
    ...
    cout<<" 5. Buscar libros en español              "<<endl;
    cout<<" 6. Buscar libros de ciencia ficcion      "<<endl;
    cout<<" 7. Eliminar libros de misterio           "<<endl;
    cout<<" 8. Salir                                 "<<endl;
